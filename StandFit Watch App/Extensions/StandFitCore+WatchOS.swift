//
//  StandFitCore+WatchOS.swift
//  StandFit Watch App
//
//  WatchOS-specific extensions for StandFitCore types
//
...
struct ExerciseColorPalette {
    ...
    // Extended palette for custom exercises (carefully chosen for watchOS visibility)
